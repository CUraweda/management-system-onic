          ...
          <div class="col-12">
            <q-item>
              <q-item-section class="q-mb-xl">
                <q-file outlined v-model="model" label="Upload File" class="q-mb-xl" @change="handUpload">
                  <template v-slot:append>
    ...
    handlUpload(event) {
      ...
      fetch('/upload', {
        ...
        .then(data => {
          ...
          // Tambahkan logika tambahan sesuai kebutuhan Anda, seperti menampilkan pesan ke pengguna, dll.
        })
        .catch(error => {
