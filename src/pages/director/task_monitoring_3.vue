          ...
          <template v-slot:body="props">
            <q-tr :props="props"
              ...
              <q-td key="status" :props="props">
                <q-chip
                  :color="(props.row.status == 'Deleted') ? 'white text-red' : (props.row.status == 'Idle') ? 'white text-orange' : (props.row.status == 'Wait-app') ? 'white text-blue-3' : (props.row.status == 'Completed') ? 'white text-blue' : (props.row.status == 'In-progress') ? 'white text-orange-3' : (props.row.status == 'Open' ? 'white text-green' : 'secondary')"
